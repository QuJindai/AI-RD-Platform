...
function statusLabel(value) {
  const labels = { QUEUED:"排队中", RUNNING:"运行中", SUCCEEDED:"已完成", FAILED:"失败", CANCELLED:"已取消", INTERRUPTED:"已中断", WAITING_APPROVAL:"等待审批", PENDING:"待审批", APPROVED:"已通过", REJECTED:"已驳回", ACTIVE:"运行中", STOPPED:"已停止", not_connected:"未连接" };
...
async function init() {
  ...
  try { await changeIdentity(state.token); }
